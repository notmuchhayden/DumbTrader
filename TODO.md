...
- [ ] 조회 버튼 추가. 버튼 클릭시 주식 t8430 을 통해서 주식 종목 리스트 조회 <== 여기 작업중
- [ ] DB 에 종목 리스트 저장 기능 구현 <== 여기 작업중
- [ ] 종목 리스트 검색 및 필터링 기능 추가
- [ ] 관심 종목 추가/삭제 기능 추가. 관심 종목은 종목 리스트의 왼쪽에 종목 이름만 나열

### 개별 종목 관리 화면 개발 (StockDetailView, StockDetailViewModel)
- [ ] 종목코드를 넣으면 현재 주가를 조회하는 화면 개발 - t1101
- [ ] 매매 전략에 대한 설명 문서 작성- [ ] 상세한 디자인은 증권사 HTS 를 참고
...
## 현재 설정 저장/불러오기 기능 개발
- [ ] 현재 선택된 계좌, 관심종목 리스트 등을 설정 파일에 저장하는 기능 구현
